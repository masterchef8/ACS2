...
class PlayMaze(object):
    ...
    def play(self, posx, posy, str1, str2):
        ...
        self.stdscr.addstr(1, 0,  str(self.matrice[1]).replace(",", " ").replace("'", "").replace("0", " 0").replace("2", " 2").replace("X", " X").replace("1", " 1"))
        self.stdscr.addstr(2, 0,  str(self.matrice[2]).replace(",", " ").replace("'", "").replace("0", " 0").replace("2", " 2").replace("X", " X").replace("1", " 1"))
        self.stdscr.addstr(3, 0,  str(self.matrice[3]).replace(",", " ").replace("'", "").replace("0", " 0").replace("2", " 2").replace("X", " X").replace("1", " 1"))
        self.stdscr.addstr(4, 0,  str(self.matrice[4]).replace(",", " ").replace("'", "").replace("0", " 0").replace("2", " 2").replace("X", " X").replace("1", " 1"))
        self.stdscr.addstr(5, 0,  str(self.matrice[5]).replace(",", " ").replace("'", "").replace("0", " 0").replace("2", " 2").replace("X", " X").replace("1", " 1"))
        self.stdscr.addstr(6, 0,  str(self.matrice[6]).replace(",", " ").replace("'", "").replace("0", " 0").replace("2", " 2").replace("X", " X").replace("1", " 1"))
